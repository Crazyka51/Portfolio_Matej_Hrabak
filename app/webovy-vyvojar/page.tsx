          ...
          <div className="container mx-auto px-4 z-10">
            ...
            >
              <h1 className="text-5xl md:text-6xl font-bold mb-6">
                Matěj Hrabák -  Webový vývojář se zaměřením na moderní technologie
              </h1>
...
const projects = [
  {
    ...
    altText: "Nexos e-commerce šablona v Next.js a TypeScript - moderní eshop",
  ...
  },
  {
    ...
    altText: "B2B SaaS platforma vytvořená v Next.js - portfolio pro business růst",
  ...
  },
  {
    ...
    altText: "Web kadeřnického salonu Zuza s rezervačním systémem v PHP",
  ...
  },
  {
    ...
    altText: "Web zastupitele Pavla Fišera v Next.js a TypeScript",
  ...
  },
  {
    ...
    altText: "Firemní web stavební společnosti Straw Stav v Next.js a TypeScript",
    category: "Firemní portfolio",
    year: "2025",
    technologies: ["NextJS", "Node", "CSS" , "TypeScript" , "Tailwind CSS"],
    github: "",
  ...
  },
  {
    ...
    altText: "Portfolio webového vývojáře Matěje Hrabáka v Next.js",
    category: "Portfolio",
    year: "2024",
